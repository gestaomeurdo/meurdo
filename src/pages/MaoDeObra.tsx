      ...
      <div className="p-4 sm:p-6 space-y-6">
        ...
        <Alert className="bg-[#066abc]/5 border-[#066abc]/20 rounded-2xl">
          ...
          <AlertDescription className="text-sm">
            Cargos cadastrados aqui aparecem como sugestão no **RDO**. Ao selecionar uma função e a quantidade, o sistema calcula o custo diário da obra automaticamente para você.
          </AlertDescription>
        </Alert>

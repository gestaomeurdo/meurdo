      ...
      <Card className={isPro ? "border-primary/50 bg-primary/5" : ""}>
        <CardHeader>
          <div className="flex justify-between items-start">
            ...
            <Badge variant={isPro ? "default" : "outline"} className="px-4 py-1">
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-3">
              <h4 className="font-semibold text-sm uppercase text-muted-foreground">Recursos PRO</h4>
              <ul className="space-y-2">
                <li className="flex items-center gap-2 text-sm">
                  <CheckCircle2 className="h-4 w-4 text-green-500" /> Obras Ilimitadas
                </li>
                <li className="flex items-center gap-2 text-sm">
                  <CheckCircle2 className="h-4 w-4 text-green-500" /> Exportação de PDF com Logotipo
                </li>
                <li className="flex items-center gap-2 text-sm">
                  <CheckCircle2 className="h-4 w-4 text-green-500" /> Assinaturas Digitais no RDO
                </li>
                <li className="flex items-center gap-2 text-sm">
              ...
              {!isPro ? (
                <div className="text-center space-y-4">
                  <p className="text-sm text-muted-foreground">
                    Libere o potencial completo da sua gestão de obras por apenas **R$ 49,90/mês**.
                  </p>
                  <UpgradeButton />
                </div>
              ) : (
                <div className="text-center space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Para cancelar ou alterar dados de pagamento, verifique seu e-mail ou entre em contato com o suporte.
                  </p>
                </div>
              )}
            </div>
